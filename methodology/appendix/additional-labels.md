...
Avoid: Treating it as an implied decision.
...
Use: Exit criteria and measurable outcomes.
Avoid: Vague aspirations.

### Out-of-Scope

Definition: Areas intentionally excluded from the current work.
Use: Prevent scope creep and misalignment.
Avoid: Long exclusion lists without impact.

### Quality Attribute

Definition: A non-functional property such as performance, reliability, or
accessibility.
Use: Cross-cutting system qualities.
Avoid: Feature behavior statements.
...
Use: Prioritization and scope alignment.
Avoid: Implementation details.

### Business Case

Definition: The justification for why this work matters.
Use: Benefit, cost, and tradeoff framing.
...
Definition: A positive outcome delivered by the work.
Use: Impact and expected gains.
Avoid: Features without outcomes.

### Cost

Definition: A resource or tradeoff required to deliver work.
Use: Budget, time, or opportunity cost.
Avoid: Estimates without basis.

### Opportunity

Definition: A potential gain or gap worth addressing.
Use: Market gaps and unmet needs.
Avoid: Unscoped ideas.

### Competitive Insight

Definition: A relevant observation about competitors or alternatives.
Use: Positioning and differentiation.
...
Definition: The intended readers or consumers of a page, section, or feature.
Use: Tailor detail and presentation.
...
Avoid: Overlapping or ambiguous segments.
...
Avoid: Technical task statements.
...
Use: Process mapping and behavior expectations.
...
Use: Experiments and research planning.
Avoid: Assumptions without a test.

### Research Question

Definition: A specific question guiding research.
Use: Study focus and scope.
Avoid: Broad topics without focus.
...
Avoid: General research activity without a hypothesis.
...
Use: Link claims to data, research, or decisions.
Avoid: Opinions without backing.

### Benchmark

Definition: A comparison point from a peer or standard.
Use: Relative performance or quality checks.
...
Use: High-level product behavior.
Avoid: Implementation details.
...
Use: Order work and decisions.
Avoid: Unclear scales or criteria.
