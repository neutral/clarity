# Decision Ledger (Locked vs Open)
...
- Locked: decided for current scope; changes require explicit intake update.
- Open: unresolved; requires follow-up before locking.
- Time-boxed open: open now, with a review date or trigger.
