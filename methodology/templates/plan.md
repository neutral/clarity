...
Purpose: shared plan and log for a clarity pass. Owner and agent update it
throughout intake, planning, and execution.
...
Exclusions:
Out of scope:
Second-order fixes outside scope (default allowed if bounded/mechanical; e.g., link updates, terminology alignment):
...
Goals:
Non-goals:
Known confusions / misinterpretation risks:
Overloaded / frequently misunderstood terms:
